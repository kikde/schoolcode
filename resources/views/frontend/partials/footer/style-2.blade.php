  ...
  <style>
    :root{
      ...
      --line:#2b3340;       /* borders */
      --accent:#e11d19;     /* green accent */
      --accent-2:#f59e0b;   /* orange accent */
      --bar-start:#f59e0b;  /* gradient left */
      --bar-end:#e11d19;    /* gradient right */
  ...
  /* Gradient social bar */
.social-bar{
  background:linear-gradient(90deg,#f59e0b,#e11d19);
  padding:12px 14px;
  display:flex;
