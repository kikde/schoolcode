                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            <label for="header_logo2">Header Logo 2</label>
                                                            <div class="media">
                                                                <a href="javascript:void(0);" class="mr-25">
                                                                    @if(!empty($settings->header_logo2))
                                                                        <img src="{{ asset('backend/uploads/'.$settings->header_logo2) }}" class="rounded mr-50" alt="header logo 2" width="200" />
                                                                    @else
                                                                        <img src="{{ asset('backend/uploads/'.$settings->site_logo) }}" class="rounded mr-50" alt="header logo 2" width="200" />
                                                                    @endif
                                                                </a>
                                                                <div class="media-body mt-75 ml-1">
                                                                    <label for="header_logo2" class="btn btn-sm btn-primary mb-75 mr-75">Upload</label>
                                                                    <input type="file" id="header_logo2" hidden accept="image/*" name="header_logo2" />
                                                                    <button class="btn btn-sm btn-outline-secondary mb-75" type="button">Reset</button>
                                                                    <p>Allowed JPG, GIF or PNG. Max size of 800kB</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="account-youtube" class="form-control"
                                                        name="youtube" placeholder="Add link"
